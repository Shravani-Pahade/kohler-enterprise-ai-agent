...
The Kohler Unified Enterprise AI Agent answers questions across **HR Policy**, **Customer Support**, and **Privacy Policy**. It demonstrates domain-aware routing, local retrieval, governed generation, dynamic response formatting, and live grounding checks in a simple pink Streamlit chat experience.
...
- Three local document domains with separate ChromaDB collections:
  - `hr_policy`
  - `customer_support`
  - `privacy_policy`
